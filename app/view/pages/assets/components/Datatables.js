          ...
          initComplete: function () {
            setTimeout(() => {
              ...
              const label = document.querySelector(
                `${selector}_wrapper .dt-search label`,
              );
              if (label) {
                label.remove();
              }
              ...
              const searchDiv = document.querySelector(
                `${selector}_wrapper .row > div.dt-layout-start`,
              );
              if (searchDiv) {
              ...
              const divSearch = document.querySelector(
                `${selector}_wrapper .dt-search`,
              );
              if (divSearch) {
              ...
              const input = document.querySelector(
                `${selector}_wrapper .dt-search input`,
              );
              if (input) {
              ...
              const pageLength = document.querySelector(
                `${selector}_wrapper .dt-length select`,
              );
              if (pageLength) {
