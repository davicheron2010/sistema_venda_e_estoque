...
import ItemSale from '../controller/itemSale.js';
...
ipcMain.handle('sale:count', async () => {
    return await Sale.count();
});

ipcMain.handle('itemSale:insert', async (_e, data) => {
    return await ItemSale.insert(data);
});